...
OGdipExampleBitmap() {
	...
	bmpTest_I1.ConvertFormat("I4", "BW")    ; Convert to dithered black-n-white
	...
	bmpTest_I4.ConvertFormat("I1", "System", False)  ; Convert to non-dithered 16-color
	...
	bmpHist := Example_CreateHistogram(bmpHalf, "SetPixel")  ; Try "SetPixel"/"LockBits"!
...
Example_CreateHistogram(source, method) {
	...
	bmpHist.G.DrawString(timeString, {family:"Arial", size:14}, 16, 16)
