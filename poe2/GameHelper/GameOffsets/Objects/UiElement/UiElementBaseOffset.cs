namespace GameOffsets.Objects.UiElement
{
    ...
    public struct UiElementBaseOffset
    {
        ...
        [FieldOffset(0x8)] public IntPtr Self;

        [FieldOffset(0x10)] public StdVector ChildrensPtr; // both points to same children UiElements.
        ...
        [FieldOffset(0xb8)] public IntPtr ParentPtr; // UiElement.
