...
if (!WinExist("ahk_id " GetHwnd( "L2R(64)", "dnplayer.exe" ))) {
	msgbox % "Please open a notepad window and press OK to reload"
	reload
}
WinActivate, % "ahk_id " GetHwnd( "L2R(64)", "dnplayer.exe" )

overlay := new ShinsOverlayClass("ahk_id " GetHwnd( "L2R(64)", "dnplayer.exe" ))
